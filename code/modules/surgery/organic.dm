...
/datum/surgery_step/cut_open/can_use(mob/living/user, obj/item/organ/external/organ, obj/item/tool)
	return BP_IS_ORGANIC(organ) || BP_IS_SLIME(organ) || BP_IS_SUPERIOR(organ) && !organ.open // added BP_IS_SUPERIOR so that exalts can be operated on in surgery
...
/datum/surgery_step/retract_skin/can_use(mob/living/user, obj/item/organ/external/organ, obj/item/tool)
	return BP_IS_ORGANIC(organ) || BP_IS_SLIME(organ) || BP_IS_SUPERIOR(organ) && organ.open == 1 // added BP_IS_SUPERIOR so that exalts can be operated on in surgery
...
/datum/surgery_step/attach_organ/can_use(mob/living/user, obj/item/organ/internal/organ, obj/item/stack/tool)
	return BP_IS_ORGANIC(organ) || BP_IS_SLIME(organ) || BP_IS_SUPERIOR(organ) && organ.is_open() && (organ.status & ORGAN_CUT_AWAY) // added BP_IS_SUPERIOR so that exalts can be operated on in surgery
...
/datum/surgery_step/amputate/can_use(mob/living/user, obj/item/organ/external/organ, obj/item/tool)
	return BP_IS_ORGANIC(organ) || BP_IS_SLIME(organ) || BP_IS_SUPERIOR(organ) && organ.owner && !organ.cannot_amputate // added BP_IS_SUPERIOR so that exalts can be operated on in surgery
